INSERT INTO AIRCRAFT (TAIL_NUMBER,AIRCRAFT_TYPE,STATION_ID,MAX_SPEED,MAX_ALTITUDE,TOTAL_FILGHT_HOURS,MAINTENANCE_FLAG,CURRENT_MAINTENANCE_HOURS,END_OF_SERVICE_DATE) VALUES (
