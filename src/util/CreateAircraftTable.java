            ...
            try (Connection conn = DriverManager.getConnection(CONNECTION);
                ...
                try {
                    ...
                    insertStatement.executeUpdate("INSERT INTO aircraft"
                            ...
                            + " end_of_service_date)"
                            + "VALUES"
                            + "('N7255N','Rotary Wing',1,130,15000,143000,false,3400,1000,NULL),"
                            + "('N6506R','Fixed Wing',1,174,18000,57000,false,56000,1000,NULL),"
                            ...
                            + "('N2233R','Fixed Wing',4,270,31000,76483,false,76483,1000,NULL),"
